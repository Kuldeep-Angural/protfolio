  ...
  return (
    <Grid container>
      <Grid md={6} sm={12} justifyContent="center" alignItems="center">
        <img src={image}  style={{ height:'646px', color: 'inherit', marginLeft: '0px', maxWidth: '100%',  }} alt="myImg" />
      </Grid>
      <Grid md={6} sm={12} maxHeight={5}>
        ...
        <Grid display="flex" gap={2} justifyContent="center" alignContent="center" alignItems="center">
          <Button variant="outlined" style={{ width: '180px', marginTop: '10px', fontSize: '20px', color: 'inherit' }} onClick={onClick} startIcon={<WorkIcon />}>
            Hire me
          </Button>
          <Button variant="outlined" style={{ width: '180px', marginTop: '10px', fontSize: '20px', color: 'inherit' }} onClick={onAboutClick} startIcon={<InfoIcon />}>
            About me
          </Button>
        </Grid>
        <Box>
